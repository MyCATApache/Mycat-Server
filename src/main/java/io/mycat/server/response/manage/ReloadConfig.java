...
public final class ReloadConfig {
	...
	private static boolean reload_all() {
        ...
        conf.reload(users, schemas, dataNodes, dataHosts, cluster, quarantine, charsetConfig, sequenceConfig, hostIndexConfig, true);
		// 处理旧的资源
    ...
    private static boolean reload() {
        ...
        // 应用重载
        conf.reload(users, schemas, dataNodes, dataHosts, cluster, quarantine, charsetConfig, sequenceConfig, hostIndexConfig, false);
