...
import io.mycat.sqlengine.response.ShowDatabases;
import io.mycat.sqlengine.response.ShowMyCATCluster;
import io.mycat.sqlengine.response.ShowMyCatStatus;
import io.mycat.sqlengine.response.ShowTables;
