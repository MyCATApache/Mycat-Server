...
public abstract class PhysicalDatasource {
	...
	private static final Logger LOGGER = Logger.getLogger(PhysicalDatasource.class);
	...
	private BackendConnection takeCon(BackendConnection conn,
			final ResponseHandler handler, final Object attachment, String schema) {
    ...
    public void getConnection(String schema,boolean autocommit, 
    		final ResponseHandler handler, final Object attachment) throws IOException {
        ...
        if (con != null) {
            ...
            if( activeCons + 1 > size ) {
                ...
                LOGGER.error("the max activeConnnections size can not be max than maxconnections" 
                		+ ", activeCons:" + activeCons + " maxCons:" + size + " idleCons:" + idleCons);
