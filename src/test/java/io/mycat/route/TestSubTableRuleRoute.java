...
public class TestSubTableRuleRoute {
    ...
    public TestSubTableRuleRoute() {
        String schemaFile = "/route/mulitRoute/schema.xml";
        String ruleFile = "/route/mulitRoute/rule.xml";
    ...
    public void testUpdate() throws SQLNonTransientException {
        String sql = "update sqtestmonth set name = 1 where id =1 and create_time = '2017-5-12'";
        SchemaConfig schema = schemaMap.get("cndb");
